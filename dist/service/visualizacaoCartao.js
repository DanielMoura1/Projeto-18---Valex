...
export function visualizacaoCartao(body) {
    return __awaiter(this, void 0, void 0, function () {
        var card, recharges, payments, recharge, payment, paymentObject, rechargeObject, i, i, resposta;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    //
                    console.log('oi');
                    return [4 /*yield*/, connection.query('select * from recharges where "cardId" =$1', [body.id])];
                case 2:
                    recharges = _a.sent();
                    console.log('oi');
                    return [4 /*yield*/, connection.query('select * from payments where "cardId" =$1', [body.id])];
                case 3:
                    payments = _a.sent();
                    recharge = 0;
                    payment = 0;
