...
export function recargas(body) {
    return __awaiter(this, void 0, void 0, function () {
        var card, date, hoje, time, cardValidade, timestamp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, connection.query('INSERT INTO recharges ("cardId",timestamp,amount) VALUES ($1, $2, $3)', [body.id, timestamp, body.valor])];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
