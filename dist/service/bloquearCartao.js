...
export function bloquearCartao(body) {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (card.rows[0].isBlocked === true) {
                        ...
                        throw { code: 'NotFound', message: 'cartao ativo' };
                    }
                    date = new Date();
                    ...
                    //
                    return [4 /*yield*/, connection.query('UPDATE cards SET "isBlocked"=$1  WHERE id = $2;', [true, body.id])];
                case 2:
                    //
                    _a.sent();
                    return [2 /*return*/];
