...
export function ativarCartao(body) {
    return __awaiter(this, void 0, void 0, function () {
        var card, date, hoje, time, cardValidade, encryptedPassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    //
                    return [4 /*yield*/, connection.query('UPDATE cards SET password=$1  WHERE id = $2;', [encryptedPassword, body.id])];
                case 2:
                    //
                    _a.sent();
